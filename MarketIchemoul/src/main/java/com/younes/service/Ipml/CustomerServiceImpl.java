...
import com.younes.repository.CustomerRepository;
import com.younes.service.CustomerService;
import com.younes.util.CustomerUtility;
...
public class CustomerServiceImpl implements CustomerService {
	...
	public void sendMail(Customer customer) {
		try {
			if (customer != null) {
				...
				String content = "Welcome to Ichemoul Hi <b>" + customer.getLastname()
	...
	@Override
	public void updateCustomerById(Long id, String firstname,String laststname,String phone, String address) {
		customerRepository.updateMyCustomer(id, firstname,laststname, phone,address );
	}
