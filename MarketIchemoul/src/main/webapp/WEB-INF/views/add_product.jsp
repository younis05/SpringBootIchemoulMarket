...
<!-- register -->
				...
				<div class="contact-grids1 w3agile-6">
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							...
							<input type="file" class="form-control" placeholder="" onchange="return fileValidation()" accept="image/png,image/jpeg,image/jpg" name="image" id="image" required="required">
							<p id="error_file"></p>
	...
	<script src="${pageContext.request.contextPath}/js/inputimages.js"></script>
